...
const loc1 = new Localisation(1, "Texas", "Denver", "Hamilton", "123", 20.25);
const loc2 = new Localisation(2, "California", "Los Angeles", "Sunset Blvd", "456", 30.50);
const loc3 = new Localisation(3, "New York", "Brooklyn", "Flatbush Ave", "789", 40.75);
...
const station4 = new ChargingStation("4", "Station D", loc3, "CHAdeMO", true, 6.00, new Date());

const user1 = new User("user1", "abc@abc.abc", "Polnaref", "Jean", "abc", "admin", "00-11-22-33-44", "token123", true);
const user2 = new User("user2", "test2@test.test", "Dio", "Brando", "user", "regular", "11-22-33-44-55", "token456", true);
const user3 = new User("user3", "test3@test.test", "Jotaro", "Kujo", "user", "regular", "22-33-44-55-66", "token789", true);
...
const booking3 = new Booking("book3", new Date(), new Date(), "cancelled", user3, station4);
...
const review3 = new Review(3, "Fast charging!", 4, new Date(), user3, station4);
...
const payment1 = new Payment(1, 250, "CB", "Payed", booking1, user1);
const payment2 = new Payment(2, 300, "PayPal", "Payed", booking2, user2);
const payment3 = new Payment(3, 400, "CreditCard", "Pending", booking3, user3);
